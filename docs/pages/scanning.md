...
![Scan tab, empty](assets/scan-empty.png#w=300&h=75vh)
...
![One tag inventoried](assets/scan-tag-list.png#w=300&h=75vh)
...
- Card whose tag has been seen over UHF → entry turns **green** (*Paired*), success
  ...
  ![Card paired with tag](assets/scan-validation-paired.png#w=300&h=75vh)
...
- Card without a matching UHF read → **red** entry pinned to the top (*missing tag*),
  ...
  ![Card without a tag](assets/scan-validation-missing.png#w=300&h=75vh)
